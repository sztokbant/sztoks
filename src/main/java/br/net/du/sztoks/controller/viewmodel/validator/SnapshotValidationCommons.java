...
public class SnapshotValidationCommons {
    ...
    public static void rejectIfInvalidCurrencyUnit(final String currencyUnit, final Errors errors) {
        rejectIfEmptyOrWhitespace(
                errors, CURRENCY_UNIT_FIELD, ValidationCommons.NOT_EMPTY_ERRORCODE);
    ...
    public static void rejectIfInvalidTithingPercentage(
        ...
        rejectIfEmptyOrWhitespace(
                errors, TITHING_PERCENTAGE_FIELD, ValidationCommons.NOT_EMPTY_ERRORCODE);
