...
class SnapshotCreditCardAccountUpdateAvailableCreditControllerTest {
    ...
    @Test
    public void updateCreditCardAvailableCredit_noCsrfToken_forbidden() throws Exception {
        // WHEN
    ...
    @Test
    public void updateCreditCardAvailableCredit_withCsrfTokenUserNotLoggedIn_redirectToLogin() throws Exception {
        // WHEN
        final ResultActions resultActions =
                mvc.perform(MockMvcRequestBuilders.post(UPDATE_CREDIT_CARD_AVAILABLE_CREDIT_URL)
                                                  .with(csrf())
    ...
    @Test
    public void updateCreditCardAvailableCredit_userNotFound_clientError() throws Exception {
        // GIVEN
    ...
    @Test
    public void updateCreditCardAvailableCredit_snapshotNotFound_clientError() throws Exception {
        // GIVEN
    ...
    @Test
    public void updateCreditCardAvailableCredit_snapshotDoesNotBelongToUser_clientError() throws Exception {
        // GIVEN
        when(userService.findByEmail(user.getEmail())).thenReturn(user);
    ...
    @Test
    public void updateCreditCardAvailableCredit_accountNotFound_clientError() throws Exception {
        // GIVEN
        when(userService.findByEmail(user.getEmail())).thenReturn(user);
    ...
    @Test
    public void updateCreditCardAvailableCredit_accountDoesNotBelongToUser_clientError() throws Exception {
        // GIVEN
        when(userService.findByEmail(user.getEmail())).thenReturn(user);
    ...
    @Test
    public void updateCreditCardAvailableCredit_accountDoesNotBelongInSnapshot_clientError() throws Exception {
        // GIVEN
        when(userService.findByEmail(user.getEmail())).thenReturn(user);
