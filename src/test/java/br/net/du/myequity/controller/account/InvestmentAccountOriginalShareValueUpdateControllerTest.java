...
class InvestmentAccountOriginalShareValueUpdateControllerTest
        extends AccountAjaxControllerTestBase {
    ...
    InvestmentAccountOriginalShareValueUpdateControllerTest() {
